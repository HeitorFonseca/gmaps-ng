...
/* harmony import */ var _home_home_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./home/home.component */ "./src/app/components/home/home.component.ts");
/* harmony import */ var _about_about_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./about/about.component */ "./src/app/components/about/about.component.ts");
...
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./auth.service */ "./src/app/services/auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _ngui_map__WEBPACK_IMPORTED_MODULE_6__["NguiMapModule"].forRoot({ apiUrl: 'https://maps.google.com/maps/api/js?key=AIzaSyCVRKkMBanRLv3SJzkcc3XaYdGB-4q1_98&libraries=visualization,places,drawing' })
            ],
            providers: [_auth_service__WEBPACK_IMPORTED_MODULE_12__["AuthService"], _auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngui_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngui/map */ "./node_modules/@ngui/map/esm5/ngui-map.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.placeChanged = function () {
        ...
        var lb = place.geometry.location.lng();
        ...
        this.drawingManager['initialized$'].subscribe(function (dm) {
            google.maps.event.addListener(dm, 'overlaycomplete', function (event) {
                if (event.type !== google.maps.drawing.OverlayType.MARKER) {
                    ...
                    _this.selectedOverlay = event.overlay;
                    _this.selectedOverlay.type = event.type;
                    var area = google.maps.geometry.spherical.computeArea(_this.selectedOverlay.getPath());
                    _this.areaText = _this.SquareMetersToHectare(area).toString();
                }
            });
        });
    };
    HomeComponent.prototype.deleteSelectedOverlay = function () {
    ...
    HomeComponent.prototype.SquareMetersToHectare = function (area) {
        return area / 10000;
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_ngui_map__WEBPACK_IMPORTED_MODULE_1__["DrawingManager"]),
        __metadata("design:type", _ngui_map__WEBPACK_IMPORTED_MODULE_1__["DrawingManager"])
    ], HomeComponent.prototype, "drawingManager", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], HomeComponent.prototype, "gmap", void 0);
...
module.exports = "<form (submit)=\"LoginUserSubmit($event)\">\n  <input type=\"text\" placeholder=\"Username\" id=\"username\" >\n  <input type=\"password\" placeholder=\"Password\" id=\"password\" >\n  <input type=\"submit\" value=\"Submit\" >\n</form>"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.LoginUserSubmit = function (event) {
...
module.exports = __webpack_require__(/*! C:\Users\heitor.araujo\Documents\wokspace\Hidrofito\gmaps-ng\src\main.ts */"./src/main.ts");
